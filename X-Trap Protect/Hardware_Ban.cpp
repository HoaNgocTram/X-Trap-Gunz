...
//
//void Data_Ban_Br(){
//	MessageBoxA(NULL,"Hardware Banido! \n\n Contate o Administrador!", phathien.Ten_Cua_So, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
//ExitProcess(0);
//}
//void Data_Ban_En(){
//	MessageBoxA(NULL,"Hardware Banned! \n\n Contact Administrator!", phathien.Ten_Cua_So, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
//ExitProcess(0);
//}
//
//void Hardware_BAN(){
...
//
//void FTP_D_Br(){
//	MessageBoxA(NULL,"HB FTP - Connection \n\n A conexão com o servidor falhou!", phathien.Ten_Cua_So, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
//ExitProcess(0);
//}
//void FTP_D_En(){
//	MessageBoxA(NULL,"GameGuard - Connection \n\n Server connection fail!", phathien.Ten_Cua_So, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
//ExitProcess(0);
//}
//
//void FTP_DC(){
...
//
//void HTTP_D_Br(){
//	MessageBoxA(NULL,"HB HTTP - Connection \n\n A conexão falhou!", phathien.Ten_Cua_So, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
//ExitProcess(0);
//}
//void HTTP_D_En(){
//	MessageBoxA(NULL,"HB HTTP - Connection \n\n Connection fail!", phathien.Ten_Cua_So, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
//ExitProcess(0);
//}
//
//void HTTP_DC(){
...
//   HINTERNET hFtpSession = InternetConnect(hInternet, phathien.IP_Server_and_Hard, INTERNET_DEFAULT_FTP_PORT, phathien.FTP_User, phathien.FTP_Pass, INTERNET_SERVICE_FTP,INTERNET_FLAG_PASSIVE,0);  // Starts a session in this case an FTP session
...
//    hFtpSession = InternetConnect(hInternet, phathien.IP_Server_and_Hard, INTERNET_DEFAULT_FTP_PORT, phathien.FTP_User, phathien.FTP_Pass, INTERNET_SERVICE_FTP, 0, 0);
//	//http    
//    DWORD rSize;
//    char buffer[47];
...
// 
//void Up_Mac(){
//	 if (phathien.Anti_Kill_Scans == 0){
//again2:
//    Up_Get_Mac_Tread();
//	Sleep (phathien.DHard_occours);
//	// Sleep (10000);
//goto again2;
//	}
//	else
...
//again:
//	DHard();      //Antikill 
//	//cout << phathien.DHard_occours/650;
//	Sleep (phathien.DHard_occours/650); // 600000 = 10 minutes, divided by 650 = 923 miliseconds
//	i++;
