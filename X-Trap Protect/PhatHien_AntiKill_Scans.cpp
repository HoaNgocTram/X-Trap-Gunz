...
void Detectors_ON(){ 
	Antikill = /*phathien.Server_Ban + phathien.Hardware_Ban + */phathien.Check_File_Names + phathien.Launcher_Check + phathien.Close_Window + phathien.Close_ClassName + phathien.Phathien_ClassName + phathien.Phathien_PID + phathien.Phathien_Dump + phathien.Phathien_Window + phathien.Phathien_Hide_Toolz + phathien.Phathien_Inject + phathien.Phathien_TuKhoa + phathien.Phathien_TuKhoa_NC + phathien.Phathien_TuKhoa_Win + phathien.Phathien_TuKhoa_Class + phathien.Virtual_Memory_Protect + phathien.Anti_Kill_Scans + phathien.Anti_Kill_Scans + phathien.GameGuard_Exe_Protection; //+ phathien.Phathien_Speed_Tickcount + phathien.Phathien_Speed_Hethong
}
...
{ 
	//MessageBoxA(NULL,"AKS-Scan\n\nAK 1", phathien.Ten_Cua_So, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
...
void A_Kill1(){
	...
	Sec();
again:	
	Sleep (phathien.Anti_Kill_Thoigian/2); 	
	DAka();
	Sec();
	i++;
...
//    DAkb();
//    DBan();
//	Sleep (phathien.Anti_Kill_Thoigian/2);  // 2000 divided by /x
//	i++;	
//	//cout << i << endl;
//	if (i == phathien.DBan_occours/1000){  // 60000 / 1000 = 60 sec
//		PHP_New_Tread();
//		i = 0;
//	goto again;
//	}
...
//	x = 0;
//if (sec == 0){	
//	//MessageBoxA(NULL,"AKS-Scan\n\nAK 2", phathien.Ten_Cua_So, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
//	DC_AKs();
